...
representatives=[]
rf_name='D2_RF corner individual seats' if 'D2_RF corner individual seats' in bpy.data.objects else ('D2_RF lower straight individual seats' if s.get('v15_corrections') else 'D2_RF return individual seats')
