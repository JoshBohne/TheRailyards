...
from r12_outfield import build_lc_bank,build_rf_corner,in_lc_bank,in_corner_bank
...
scene['v12_proportions']=json.dumps({'bowl_front':spec['bowl_front_basis'],'left_center_bank':lc,'rf_corner':corner,
