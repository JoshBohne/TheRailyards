...
def create_materials():
    ...
    palette={
        ...
        # V5 facade palette (daylight-readable; no emission)
        'limestone':((.72,.66,.54),.74,0),'granite_grey':((.42,.43,.42),.55,.05),'granite_pink':((.60,.44,.39),.55,.05),'precast':((.57,.58,.55),.72,0),
        'terracotta':((.52,.31,.22),.76,0),'white_marble':((.82,.80,.75),.48,0),'crown_white':((.78,.80,.80),.42,0),'paint_red':((.66,.05,.035),.5,0),
        'black_steel':((.028,.03,.034),.35,.6),'copper_green':((.22,.38,.30),.55,.2),'glass_dark':((.05,.06,.07),.15,.35),'glass_blue':((.10,.21,.28),.15,.2),
        'glass_green':((.09,.20,.16),.15,.2),'glass_bronze':((.17,.11,.06),.18,.3),'glass_white':((.36,.42,.46),.14,.25),'glass_grey':((.24,.27,.29),.16,.25),
