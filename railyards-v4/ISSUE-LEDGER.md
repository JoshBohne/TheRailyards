...
| Park from Roosevelt | continuous 0.045 ramp z 14.1 → 22 | flat plaza z 14.1 → 15.4, arched terrace front at y 160 to z 22, 20 m grand stair on the river side | `v12-bridge.png` vs `../reconstruction-references/user-bridge-view.png`, `N5_park_to_bleachers`, `C_entrance_landing` |
